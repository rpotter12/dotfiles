...
( : '~'.~.'~' : ) Uptime.............: ${UPTIME}
 ~ .~       ~. ~  Memory.............: $(grep MemFree /proc/meminfo | awk {'print $2'})kB (Free) / $(grep MemTotal /proc/meminfo | awk {'print $2'})kB (Total)$(tput setaf 7)
  ...
  '~         ~'  $(tput setaf 1) IP Address.........: $(hostname -I) $(tput setaf 7)
    *--~-~--*    $(tput setaf 1) Battery............: $(acpi)%
                 $(tput setaf 1) Temperature........: CPU: $cpuTempC°C/$cpuTempF°F GPU: ${gpuTempC:5:2}°C/$gpuTempF°F
		 $(tput setaf 6) https://github.com/rpotter12
$(tput sgr0)"
}
